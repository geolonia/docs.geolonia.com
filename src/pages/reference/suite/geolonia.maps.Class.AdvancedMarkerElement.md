...
[@geolonia/maps-suite](/reference/suite/geolonia.Namespace.maps) / [geolonia](/reference/suite/geolonia.Namespace.maps) / [maps](/reference/suite/geolonia.Namespace.maps) / AdvancedMarkerElement

# Class: AdvancedMarkerElement

任意の DOM 要素を見た目として持つマーカーです。

[Marker](/reference/suite/geolonia.maps.Class.Marker) の画像アイコンよりもリッチなコンテンツが必要な場合に使用します。
