...
[@geolonia/maps-suite](/reference/api/) / [geolonia](/reference/api/Namespace.geolonia) / [maps](/reference/api/geolonia.Namespace.maps) / InfoWindow
...
[`InfoWindowOptions`](/reference/api/geolonia.maps.Interface.InfoWindowOptions)
...
ウィンドウを紐付ける [Marker](/reference/api/geolonia.maps.Class.Marker)（省略可能）です。
