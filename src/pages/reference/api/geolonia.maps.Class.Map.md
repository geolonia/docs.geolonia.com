...
[@geolonia/maps-suite](/reference/api/) / [geolonia](/reference/api/Namespace.geolonia) / [maps](/reference/api/geolonia.Namespace.maps) / Map
...
[addListener](/reference/api/geolonia.maps.Class.MVCObject#addlistener) で登録します。地図は
...
[`MapOptions`](/reference/api/geolonia.maps.Interface.MapOptions) = `{}`
...
[`LatLngBoundsLiteralOrLatLngBounds`](/reference/api/geolonia.maps.TypeAlias.LatLngBoundsLiteralOrLatLngBounds)

表示する領域です。

##### padding?

`number` \| [`Padding`](/reference/api/geolonia.maps.Interface.Padding)

矩形領域（地理的な範囲）の周囲に確保する余白（ピクセル単位）です。
  すべての辺に適用される単一の値、または辺ごとに制御する [Padding](/reference/api/geolonia.maps.Interface.Padding)
  オブジェクトのいずれかを指定します。
...
> **getBounds**(): [`LatLngBounds`](/reference/api/geolonia.maps.Class.LatLngBounds) \| `null`
...
[`LatLngBounds`](/reference/api/geolonia.maps.Class.LatLngBounds) \| `null`

***

### getCenter()

> **getCenter**(): [`LatLng`](/reference/api/geolonia.maps.Class.LatLng) \| `null`
...
> **getProjection**(): [`MapCanvasProjection`](/reference/api/geolonia.maps.Class.MapCanvasProjection) \| `null`

地理座標と画面上のピクセルとを相互に変換するための
[MapCanvasProjection](/reference/api/geolonia.maps.Class.MapCanvasProjection) を返します。地図の準備ができていない場合は
`null` を返します。

#### Returns

[`MapCanvasProjection`](/reference/api/geolonia.maps.Class.MapCanvasProjection) \| `null`
