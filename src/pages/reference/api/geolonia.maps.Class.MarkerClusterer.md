...
[@geolonia/maps-suite](/reference/api/) / [geolonia](/reference/api/Namespace.geolonia) / [maps](/reference/api/geolonia.Namespace.maps) / MarkerClusterer
...
[setMap](/reference/api/geolonia.maps.Class.Marker#setmap) で自分で地図を変更しないでください。
...
[`MarkerClustererOptions`](/reference/api/geolonia.maps.Interface.MarkerClustererOptions)
...
> **getMarkers**(): [`Marker`](/reference/api/geolonia.maps.Class.Marker)[]
