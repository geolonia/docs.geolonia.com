...
[@geolonia/maps-suite](/reference/api/) / [geolonia](/reference/api/Namespace.geolonia) / [maps](/reference/api/geolonia.Namespace.maps) / MVCObject

# Class: MVCObject

スイート内のすべてのコンポーネント（[Map](/reference/api/geolonia.maps.Class.Map) や [Marker](/reference/api/geolonia.maps.Class.Marker) など）の
基底クラスです。
...
- [`AdvancedMarkerElement`](/reference/api/geolonia.maps.Class.AdvancedMarkerElement)
- [`InfoWindow`](/reference/api/geolonia.maps.Class.InfoWindow)
- [`Map`](/reference/api/geolonia.maps.Class.Map)
- [`Marker`](/reference/api/geolonia.maps.Class.Marker)
- [`MarkerClusterer`](/reference/api/geolonia.maps.Class.MarkerClusterer)
- [`MVCArray`](/reference/api/geolonia.maps.Class.MVCArray)
- [`OverlayView`](/reference/api/geolonia.maps.Class.OverlayView)
